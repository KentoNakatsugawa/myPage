...
const recommendedVehicles = [
  {
    ...
    monthlyPrice: 54800,
    fuelEfficiency: '32.6km/L',
    year: '2024年式',
    recommendation: 'あなたの走行傾向だとより燃費の良いプリウスがおすすめ！',
    matchScore: 98,
    highlights: [
      { icon: Fuel, text: '燃費32.6km/Lで月々約5,000円お得に' },
      { icon: Leaf, text: 'CO2排出量を年間約30%削減' },
      { icon: Shield, text: '最新の安全装備Toyota Safety Sense搭載' },
    ],
    specs: {
      engine: '1.8L ハイブリッド',
      power: '140ps',
